...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post bugs_url, params: { bug: { deadline: @bug.deadline, status: @bug.status, title: @bug.title, type: @bug.type, user_id: @bug.user_id } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { deadline: @bug.deadline, status: @bug.status, title: @bug.title, type: @bug.type, user_id: @bug.user_id } }
